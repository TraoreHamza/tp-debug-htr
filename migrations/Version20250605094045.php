 ...
 */
final class Version20250605094045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, creator_id INTEGER NOT NULL, updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
